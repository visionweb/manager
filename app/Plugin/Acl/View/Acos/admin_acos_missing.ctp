...
echo "<div class='span10 view'>";
    ...
    <div class="error">
        ...
        <?php
        echo '<p class="warning">' . __d('acl', 'Some controllers have been modified, resulting in actions that are not referenced as ACO in the database.') . ' :</p>';
        ...
        echo $this->Html->link(__d('acl', 'Build missing ACOs'), '/admin/acl/acos/build_acl/run');
        echo '</p>';
