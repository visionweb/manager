...
?>
    ...
    <tr>
    	...
    	foreach($groups as $group)
    	{
    	    ...
    	    echo $group[$group_model_name][$group_display_field];
    	    if($group[$group_model_name][$group_pk_name] == $user[$user_model_name][$group_fk_name])
    	    {
    	    ...
    	    else
    	    {
    	        ...
    	        echo $this->Html->link($this->Html->image('/acl/img/design/tick_disabled.png'), array('plugin' => 'acl', 'controller' => 'aros', 'action' => 'update_user_group', 'user' => $user[$user_model_name][$user_pk_name], 'group' => $group[$group_model_name][$group_pk_name]), array('title' => $title, 'alt' => $title, 'escape' => false));
    	    }
